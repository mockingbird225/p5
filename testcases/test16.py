...
def test(cmd):
    ...
    res1 = commands.getoutput("./testclient localhost 8001 /testdata/file1.txt");
    time.sleep(1)
    res2 = commands.getoutput("./testclient localhost 8001 /testdata/file1.txt")
    time.sleep(1)
    res3 = commands.getoutput("./testclient localhost 8001 /testdata/file1.txt")
    time.sleep(1)
    res4 = commands.getoutput("./testclient localhost 8001 /testdata/file1.txt")
...
# test SFF server
test("./server 8001 1 4 FIFO")
test("./server 8001 1 4 SFF")
test("./server 8001 1 4 SFF-BS 2")
